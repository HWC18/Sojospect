...
def injection(edgeBrowser,payload,url,username,password,loginfield,loginurl):
        ...
        checks=[]
        dates=[]
        numonly=['Phone','Postal Code','Email','phone','email','Capacity',"Fee"]
        for tag in inputs:
            ...
            if url2==f"{loginurl}":
                ...
                if afterurl == url:
                    ...
                    if sure2 ==[]:
                        ...
                        print('pass')
                        data=[url,payload,'pass']
                        db_cursor = db_connection.cursor()
                        # Insert a row into the MySQL table
                        vulnerability = "Injection"
                        description = "Injection attack can be done on the following url: " + url + " Payload used: " + payload
